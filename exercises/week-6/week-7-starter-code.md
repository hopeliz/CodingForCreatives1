# Week 7 Starter Code \(really from Week 6\)

Please use the code we ended with on Thursday or create a script called MarioMove with the code below and add it to your Mario object.

{% hint style="info" %}
The code might be slightly different but should still work as we continue.
{% endhint %}
